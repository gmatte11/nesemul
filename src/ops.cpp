...
const ops::metadata operation_data[] = {
    ...
    {PHP, Non, 3, " PHP"}, {ORA, Imm, 2, " ORA"}, {ASL, Non, 2, " ASL"}, {XXX, Non, 2, "****"}, {NOP, Abs, 4, "*NOP"}, {ORA, Abs, 4, " ORA"}, {ASL, Abs, 6, " ASL"}, {SLO, Abs, 6, "*SLO"},
    ...
    {PLP, Non, 4, " PLP"}, {AND, Imm, 2, " AND"}, {ROL, Non, 2, " ROL"}, {XXX, Non, 2, "****"}, {BIT, Abs, 4, " BIT"}, {AND, Abs, 4, " AND"}, {ROL, Abs, 6, " ROL"}, {RLA, Abs, 6, "*RLA"},
    ...
    {PHA, Non, 3, " PHA"}, {EOR, Imm, 2, " EOR"}, {LSR, Non, 2, " LSR"}, {XXX, Non, 2, "****"}, {JMP, Abs, 3, " JMP"}, {EOR, Abs, 4, " EOR"}, {LSR, Abs, 6, " LSR"}, {SRE, Abs, 6, "*SRE"},
    ...
    {PLA, Non, 4, " PLA"}, {ADC, Imm, 2, " ADC"}, {ROR, Non, 2, " ROR"}, {XXX, Non, 2, "****"}, {JMP, Ind, 5, " JMP"}, {ADC, Abs, 4, " ADC"}, {ROR, Abs, 6, " ROR"}, {RRA, Abs, 6, "*RRA"},
    ...
    {DEY, Non, 2, " DEY"}, {NOP, Imm, 2, "*NOP"}, {TXA, Non, 2, " TXA"}, {XXX, Non, 2, "****"}, {STY, Abs, 4, " STY"}, {STA, Abs, 4, " STA"}, {STX, Abs, 4, " STX"}, {SAX, Abs, 4, "*SAX"},

    // BCC(90)             STA(91)                ???(92)                ???(93)                STY(94)                STA(95)                STX(96)                *SAX(97)
    {BCC, Rel, 2, " BCC"}, {STA, InY, 6, " STA"}, {XXX, Non, 2, "****"}, {XXX, Non, 6, "****"}, {STY, ZPX, 4, " STY"}, {STA, ZPX, 4, " STA"}, {STX, ZPY, 4, " STX"}, {SAX, ZPY, 4, "*SAX"},

    // TYA(98)             STA(99)                TXS(9A)                ???(9B)                ???(9C)                STA(9D)                ???(9E)                ???(9F)
    {TYA, Non, 2, " TYA"}, {STA, AbY, 5, " STA"}, {TXS, Non, 2, " TXS"}, {XXX, Non, 5, "****"}, {XXX, Non, 5, "****"}, {STA, AbX, 5, " STA"}, {XXX, Non, 5, "****"}, {XXX, Non, 5, "****"},
    ...
    {TAY, Non, 2, " TAY"}, {LDA, Imm, 2, " LDA"}, {TAX, Non, 2, " TAX"}, {XXX, Non, 2, "****"}, {LDY, Abs, 4, " LDY"}, {LDA, Abs, 4, " LDA"}, {LDX, Abs, 4, " LDX"}, {LAX, Abs, 4, "*LAX"},
    ...
    {CLV, Non, 2, " CLV"}, {LDA, AbY, 4, " LDA"}, {TSX, Non, 2, " TSX"}, {XXX, Non, 4, "****"}, {LDY, AbX, 4, " LDY"}, {LDA, AbX, 4, " LDA"}, {LDX, AbY, 4, " LDX"}, {LAX, AbY, 4, "*LAX"},
    ...
    {INY, Non, 2, " INY"}, {CMP, Imm, 2, " CMP"}, {DEX, Non, 2, " DEX"}, {XXX, Non, 2, "****"}, {CPY, Abs, 4, " CPY"}, {CMP, Abs, 4, " CMP"}, {DEC, Abs, 6, " DEC"}, {DCP, Abs, 6, "*DCP"},
    ...
    {CPX, Imm, 2, " CPX"}, {SBC, InX, 6, " SBC"}, {XXX, Non, 2, "****"}, {ISB, InX, 8, "*ISB"}, {CPX, ZPg, 3, " CPX"}, {SBC, ZPg, 3, " SBC"}, {INC, ZPg, 5, " INC"}, {ISB, ZPg, 5, "*ISB"},
