...
namespace
{
    const ops::metadata operation_data[] =
    {
        // BRK(00)           ORA(01)           nop(02)           nop(03)           nop(04)           ORA(05)           ASL(06)           nop(07)
           {1, 7, 0, "BRK"}, {2, 0, 8, "ORA"}, {0, 0, 0, "***"}, {0, 0, 0, "***"}, {0, 0, 0, "***"}, {2, 1, 2, "ORA"}, {2, 0, 2, "ASL"}, {0, 0, 0, "***"},

        // PHP(08)           ORA(09)           ASL(0A)           nop(0B)           nop(0C)           ORA(0D)           ASL(0E)           nop(0F)
           {1, 3, 0, "PHP"}, {2, 0, 1, "ORA"}, {1, 0, 0, "ASL"}, {0, 0, 0, "***"}, {0, 0, 0, "***"}, {3, 0, 4, "ORA"}, {3, 0, 4, "ASL"}, {0, 0, 0, "***"},
        ...
        // RTI(40)           EOR(41)           nop(42)           nop(43)           nop(44)           EOR(45)           LSR(46)           nop(47)
           {1, 6, 0, "RTI"}, {2, 0, 8, "EOR"}, {0, 0, 0, "***"}, {0, 0, 0, "***"}, {0, 0, 0, "***"}, {2, 0, 2, "EOR"}, {2, 0, 2, "LSR"}, {0, 0, 0, "***"},
        ...
        // RTS(60)           ADC(61)           nop(62)           nop(63)           nop(64)           ADC(65)           ROR(66)           nop(67)
           {1, 6, 0, "RTS"}, {2, 0, 8, "ADC"}, {0, 0, 0, "***"}, {0, 0, 0, "***"}, {0, 0, 0, "***"}, {2, 0, 2, "ADC"}, {2, 0, 2, "ROR"}, {0, 0, 0, "***"},
        ...
        // nop(80)           STA(81)           nop(82)           nop(83)           STY(84)           STA(85)           STX(86)           nop(87)
           {0, 0, 0, "***"}, {2, 0, 8, "STA"}, {0, 0, 0, "***"}, {0, 0, 0, "***"}, {2, 0, 2, "STY"}, {2, 0, 2, "STA"}, {2, 0, 2, "STX"}, {0, 0, 0, "***"},

        // DEY(88)           nop(89)           TXA(8A)           nop(8B)           STY(8C)           STA(8D)           STX(8E)           nop(8F)
           {1, 0, 0, "DEY"}, {0, 0, 0, "***"}, {1, 0, 0, "TXA"}, {0, 0, 0, "***"}, {3, 0, 4, "STY"}, {3, 0, 4, "STA"}, {3, 0, 4, "STX"}, {0, 0, 0, "***"},
        ...
        // LDY(A0)           LDA(A1)           LDX(A2)           nop(A3)           LDY(A4)           LDA(A5)           LDX(A6)           nop(A7)
           {2, 0, 1, "LDY"}, {2, 0, 8, "LDA"}, {2, 0, 1, "LDX"}, {0, 0, 0, "***"}, {2, 0, 2, "LDY"}, {2, 0, 2, "LDA"}, {2, 0, 2, "LDX"}, {0, 0, 0, "***"},

        // TAY(A8)           LDA(A9)           TAX(AA)           nop(AB)           LDY(AC)           LDA(AD)           LDX(AE)           nop(AF)
           {1, 0, 0, "TAY"}, {2, 0, 1, "LDA"}, {1, 0, 0, "TAX"}, {0, 0, 0, "***"}, {3, 0, 4, "LDY"}, {3, 0, 4, "LDA"}, {3, 0, 4, "LDX"}, {0, 0, 0, "***"},
